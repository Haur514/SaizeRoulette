...
function RoulettePane({menuCandidate}) {
  ...
  return (
    <RoulettePaneParent>
      <CharDisplayPane>
        <CharDisplay char={menu[0]} isPress={isPress0} setIsPress={setIsPress0}></CharDisplay>
        <CharDisplay char={menu[1]} isPress={isPress1} setIsPress={setIsPress1}></CharDisplay>
        <CharDisplay char={menu[2]} isPress={isPress2} setIsPress={setIsPress2}></CharDisplay>
        <CharDisplay char={menu[3]} isPress={isPress3} setIsPress={setIsPress3}></CharDisplay>
      </CharDisplayPane>
